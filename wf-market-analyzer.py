...
This tool analyzes the Warframe Market API to find the best items to trade,
balancing both profit margins and trading frequency.
"""
...
from config import (
    API_BASE_URL, REQUESTS_PER_SECOND, HEADERS, 
    OUTPUT_FILE, DEBUG_MODE, PROFIT_WEIGHT, VOLUME_WEIGHT,
    PRICE_SAMPLE_SIZE
)
...
class SetProfitAnalyzer:
    ...
    def calculate_average_price(self, orders: List[Dict], order_type: str, count: int = PRICE_SAMPLE_SIZE) -> Optional[float]:
        ...
        Args:
            ...
            count: Number of orders to average (defaults to configured PRICE_SAMPLE_SIZE)
...
if __name__ == "__main__":
    ...
    print(f"Using profit weight: {PROFIT_WEIGHT}, volume weight: {VOLUME_WEIGHT}")
    ...
    try:
        ...
        print("Check wf_market_analyzer.log for details.")
